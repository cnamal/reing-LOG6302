...
public abstract class AbstractVisitor implements JavaParser1_7Visitor
{
    protected static IPrint ip;
    ...
    public Object visit(Brackets node, Object data){
        propagate(node,data);
        return data;
    }
    ...
    public abstract void dumpData(AbstractOutput absOutput);
